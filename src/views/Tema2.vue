...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .row.justify-content-center.align-items-center.my-lg-4
          .col-lg-8
            .number(data-number="01")
              ...
              p Para que podamos comprender la etiqueta en eventos sociales debemos tener presente que estos, aunque son tan diversos, tienen como objetivo implícito la interacción entre las personas; es por esto que, para cada ocasión, se establecen algunas normas de conducta y de trato entre sus participantes. Estas normas están definidas por la <b>cultura</b> y el<b> estilo de vida</b>; son distintas las normas de etiqueta usadas en la mesa en países del continente americano a las usadas en los países del Medio Oriente, o las de los pueblos indígenas y ancestrales.
              p La etiqueta y el <b>comportamiento en la mesa</b> es un aspecto fundamental en actos sociales, abarca desde cómo se pone la mesa hasta los modales durante el evento, e incluyen temas como la medida prudente del consumo de los alimentos que se ofrezcan. Todo lo que hace referencia a lo social, marca normas de etiqueta, por ejemplo, saludar y agradecer en cada evento al cual se asista.
        ...
        .row.justify-content-center.align-items-center.my-lg-4
          .col-lg-7
            .number(data-number="02")
              ...
              p La etiqueta no se refiere exclusivamente a la forma de vestir, sino también a la imagen que impartimos por nuestra manera de actuar, hablar, gesticular, el lenguaje que empleamos, etc. Aunque el traje seleccionado debe adecuarse a cada situación, es también muy importante la personalidad, ya que no a todo el mundo le queda bien las mismas cosas; de igual manera, el que un determinado atuendo nos quede bien, no significa que podamos usarlo para cualquier ocasión.  Se debe tener en cuenta que nuestra presentación personal será vista como una proyección de la imagen de la empresa a la que pertenecemos. Muchas empresas que tienen uniformes exigen normas o reglas de etiqueta en su uso, debido a que estos representan su imagen. También aplican normas de etiqueta en los ascensores y lugares donde se reúnen sus colaboradores. Estas normas se emplean como cortesía en situaciones cotidianas y se aplican tanto dentro de la organización, como fuera de ella.
              p Muchas empresas, de acuerdo con sus políticas organizacionales y su búsqueda de pertenencia y pertinencia, tienen manuales de convivencia para regular el comportamiento de los empleados en distintas situaciones, frente a diversas interacciones y propósitos.
              h5 En la etiqueta empresarial es importante tener en cuenta los siguientes aspectos:
              ...
              p El tratamiento en la recepción de personalidades y autoridades es fundamental. Se debe saber tratar a cada persona en función de su cargo o su rango, por ejemplo: su majestad (en el caso de reyes), excelencia (para jefes de Estado), señoría, señor o señora. 
      ...
      .col-12
        .bloque-texto-g.color-primario.tarjetaimgcar.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto2.p-4
            .col-lg-12
              p Estas normas de conducta abarcan tanto el comportamiento de la persona como su imagen o presentación. Es importante tener en cuenta las normas de etiqueta que hombres y mujeres deben seguir en un evento empresarial, puesto que la imagen corporativa es un factor relevante. A continuación, se dan a conocer algunos requisitos para tener presentes en la forma de vestir.

      b.mt-5 La etiqueta en la vestimenta del hombre debe tener en cuenta:
    ...
    .row.mt-5.justify-content-center
      .col-lg-6
        p En el siguiente video "Normas de etiqueta y protocolo" (SENA, 2021), podrá ver con mayor claridad el concepto y diferencia entre etiqueta y protocolo: 

        .col-lg-12
          a.anexo.mb-4(href="https://www.youtube.com/watch?v=a-BgD2Cb0po" target="_blank")
              .anexo__icono
      ...
      .col-lg-4
        figure
          img(src='@/assets/curso/temas/tema2/img11.png', alt='Texto que describa la imagen').imagen-deco
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h3.mb-1 Anexo 2
                  p.mb-0 Le invitamos a estudiar el Anexo 2 - Etiqueta y protocolo, para complementar el tema.

                .col-sm-auto
                  a.boton.color-acento-contenido.texto-blanco(:href="obtenerLink('/downloads/Anexo_2_ Etiqueta y protocolo.pdf')" target="_blank")
                    span Descargar
